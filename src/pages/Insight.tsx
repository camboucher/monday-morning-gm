...
import { ChevronLeft, ChevronRight, Trophy, Brain, ArrowUpDown, UserPlus, Heart, Shuffle } from 'lucide-react';
import { InsightPage } from '@/types';

const FantasyWrappedStory = () => {
  ...
  const insights: InsightPage[] = [
    {
      ...
      description: "Sarah dominated the draft with 1,865 points from drafted players",
        ...
        {insights.map((_, index) => (
          ...
          >
            <motion.div
              ...
              transition={index === currentPage ? { duration: 5, ease: "linear" } : { duration: 0.5 }}
            />
          </div>
        ))}
      </div>
...
export default FantasyWrappedStory;